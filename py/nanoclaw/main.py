...
from nanoclaw.credential_proxy import start_credential_proxy
...
from nanoclaw.group_folder import resolve_group_folder_path
...
from nanoclaw.remote_control import (
    restore_remote_control,
    start_remote_control,
    stop_remote_control,
)
from nanoclaw.router import find_channel, format_messages, format_outbound
...
if TYPE_CHECKING:
    from nanoclaw.container_runner import AvailableGroup
    from nanoclaw.types import Channel, NewMessage, RegisteredGroup
...
async def _message_loop(shutdown_event: asyncio.Event) -> None:
    ...
    logger.info("NanoClaw running", trigger=f"@{ASSISTANT_NAME}")
