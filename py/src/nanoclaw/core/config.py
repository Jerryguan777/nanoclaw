...
# Legacy globals kept as defaults for backward compatibility during migration.
# New code should use CoworkerConfig.name / Conversation.trigger_pattern instead.
