"""Tests for nanoclaw.router."""

from nanoclaw.core.types import NewMessage
from nanoclaw.orchestration.router import escape_xml, format_messages, format_outbound, strip_internal_tags
...
def test_find_channel_found() -> None:
    ...
    from nanoclaw.orchestration.router import find_channel
...
async def test_route_outbound() -> None:
    ...
    from nanoclaw.orchestration.router import route_outbound
